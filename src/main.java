...
public class main {
    ...
    /**
     * 1: Create a String to hold some text,
     * decide on the text you want it to hold and then name it appropriately
    ...
    /**
     * 2: Edit the code below so it prints out the first name and last name in uppercase,
     * and the middle name in lower case
     */
    private static void exercise2() {
        System.out.println("\nExercise 2:");
        // Change these
        String firstName = "Methu";
        String middleName = "Sela";
    ...
    private static void exercise3() {
        ...
        String primitive = String.valueOf(67);
        int textFromPrimitives =Integer.valueOf(primitive);
        System.out.println(textFromPrimitives);
/*
            String primitives2 = String.valueOf(true);
            boolean primitive2 = boolean.valueOf(primitives2);
            System.out.println(primitive2);
*/
        String textFrom2Primitives = "La mia altezza è=" + 158 + "cm" ; // <--- Edit this line
        System.out.println(textFrom2Primitives);
        System.out.println(textFrom2Primitives + " " + 1.5 );
